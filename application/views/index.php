...
<head>
  ...
  <body class="header-fixed-top" style="background-color: #FFEBEE;">
     ...
     <div class="container">
      <div class="row">
       <div class="col-sm-8 pull-left">
        <img src="assets/images/cempaka/logocempaka.jpg" alt="Site Logo"></a>
      </div>
      <div class="col-sm-4" style="margin-top: 80px;">
        <form role="search" class="search-field" action="#" method="get">
...
<header id="main-menu" class="main-menu" style="font-family: candara;font-size: 20px;color:#FF00FF">
 <div class="container">
  <div class="row">
   <div class="col-sm-11">
    ...
    <div class="menu-logo">
      <a href="./"><img src="assets/images/cempaka/logocempaka.jpg" alt="menu Logo"></a>
    </div><!-- /.menu-logo -->
  </div>
  <nav id="menu" class="menu collapse navbar-collapse">
   <ul id="headernavigation" class="menu-list nav navbar-nav">
    <li class="active"><a href="#page-top">Beranda</a></li>
    <li><a href="#about">Selebriti</a></li>
    <li><a href="#portfolio">Gaya Hidup</a></li>
    <li><a href="#services">Kesehatan</a></li>
    <li><a href="#latest-post">Kuliner</a></li>
    <li><a href="#contact">Insani</a></li>
    <li><a href="#contact">Solusi</a></li>
    <li><a href="#contact">Senyum Cempaka</a></li>
  </ul><!-- /.menu-list -->
</nav><!-- /.menu-list -->
</div>
</div><!-- /.row -->
    ...
    <div class="row">
      <div class="col-sm-8">
        ...
        <div class="col-sm-6">
          <div class="item">  
            <div class="item-top">
               <h3 class="item-title">Selebriti</h3>
             </div>
            <div class="item-image">
              <img class="img img-responsive" src="assets/images/cempaka/atoz7.JPG" style="margin-bottom: 10px">
                <div align="right">
                  <h8>12 juni 2017</h8>
                </div>
            </div>
      ...
      <div class="col-sm-4">
        <div class="item">
          <div class="item-image" align="center">
            <img class="img img-responsive" src="assets/images/author/1.jpg">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row" style="margin-top: 40px">
      <div class="col-sm-8" style="padding: 20px">
        <div class="col-sm-6" align="center">
          <img class="img img-responsive" width="250" src="assets/images/travel.png">
        </div>
        <div class="col-sm-6" align="center">
          <img class="img img-responsive" width="250" src="assets/images/suaramerdeka.jpg">
        </div>
      </div>
      <div class="col-sm-4">
        <h2 class="panel-heading" align="center">TERPOPULER</h2>
    ...
    <div class="row" style="margin-top: 40px">
      <div class="col-sm-8" style="padding: 20px">
        <div class="post-area-top text-center">
          <h2 class="post-area-title">Kuliner</h2>
      ...
      <div class="col-sm-4">
        <h2 class="panel-heading" align="center">GAYA HIDUP</h2>
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
              <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                  <div class="panel-body">
                    <span class="service-image"><img src="assets/images/services/1.jpg" alt="Service Image"></span>
              ...
              <div class="panel panel-default">
                ...
                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                  <div class="panel-body">
                    <span class="service-image"><img src="assets/images/services/2.jpg" alt="Service Image"></span>
                    <p>
                      consectetuer adipiscing elit. Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi Sed egestas, ante et vulputate volutpat is, gravida id
                    </p>
                  </div>
              ...
              <div class="panel panel-default">
                ...
                <div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
                  <div class="panel-body">
                    <span class="service-image"><img src="assets/images/services/3.jpg" alt="Service Image"></span>
                    <span class="accordion-title">Lorem ipsum dolor sit amet</span>
                    <p>
                      consectetuer adipiscing elit. Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi Sed egestas, ante et vulputate volutpat is, gravida id
                    </p>
