                ...
                <div class="container">
                    <div class="row AdjustRow">
                            ...
                            <div class="widget">
                                ...
                                <div class="about--widget">
                                    ...
                                    <ul class="nav">
                                        ...
                                        <li> <i class="fa fa-envelope-o"></i> <a href="http://themelooks.us/cdn-cgi/l/email-protection#c0a5b8a1adb0aca580a5b8a1adb0aca5eea3afad"><span class="__cf_email__" data-cfemail="8feaf7eee2ffe3eacfeaf7eee2ffe3eaa1ece0e2">[email&#160;protected]</span></a> </li>
                        ...
                        <div class="col-md-3 col-xs-6 col-xxs-12 ptop--30 pbottom--30">
                            <div class="widget">
                                <div class="widget--title">
                                    <h2 class="h4">Advertisements</h2> <i class="icon fa fa-bullhorn"></i> </div>
                                <div class="links--widget">
                                    <ul class="nav">
                        ...
                        <div class="col-md-3 col-xs-6 col-xxs-12 ptop--30 pbottom--30">
                            <div class="widget">
                                <div class="widget--title">
                                    <h2 class="h4">Career</h2> <i class="icon fa fa-user-o"></i> </div>
                                <div class="links--widget">
                                    <ul class="nav">
