            ...
            <div class="header--mainbar">
                <div class="container">
                    <div class="header--logo float--left float--sm-none text-sm-center">
                        <h1 class="h1"> <a href="home-1.html" class="btn-link"> <img width="250px" src="assets/img/logo.jpg" alt="USNews Logo"> <span class="hidden">USNews Logo</span> </a> </h1> </div>
                    <div class="header--ad float--right float--sm-none hidden-xs">
                        <a href="#"> <img src="assets/img/ads-img/ad-728x90-01.jpg" alt="Advertisement"> </a>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    ...
                    <div id="headerNav" class="navbar-collapse collapse float--left">
                        <ul class="header--menu-links nav navbar-nav" data-trigger="hoverIntent">
                            <li class="dropdown active"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Beranda<i ></i></a>
                            ...
                            <li><a href="sports.html">Kesehatan</a></li>
                            <li class="dropdown megamenu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Senyum Cempaka<i class=""></i></a>
